 ...
 */
public class YaoPingAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private final int TYPE_FOOTER = 0;
    private final int TYPE_ITEM = 1;

    private Context context;
    private ArrayList<YaoPing> list;

    private OnItemClickListener mOnItemClickListener;

    private boolean mShowFooter = true;

    public YaoPingAdapter(Context context, ArrayList<YaoPing> list) {
