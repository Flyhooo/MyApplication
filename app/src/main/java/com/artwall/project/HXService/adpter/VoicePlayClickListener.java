...
public class VoicePlayClickListener implements View.OnClickListener {
    ...
    public void stopPlayVoice() {
        ...
        if (message.direct() == EMMessage.Direct.RECEIVE) {
            voiceIconView.setImageResource(R.drawable.ic_menu_camera);
        } else {
            voiceIconView.setImageResource(R.drawable.ic_menu_camera);
        }
        // stop play voice
        ...
        isPlaying = false;
        ((WeChatActivity) activity).playMsgId = null;
    ...
    public void playVoice(String filePath) {
        ...
        ((WeChatActivity) activity).playMsgId = message.getMsgId();
        AudioManager audioManager = (AudioManager) activity
                .getSystemService(Context.AUDIO_SERVICE);

        mediaPlayer = new MediaPlayer();
//		if (EMClient.getInstance().getOptions()..getUseSpeaker()) {
